...
public class SSLContextFactory {
	...
	public static SSLContext generate(File certFolder, String keyPassword) {
	    ...
	    try {
	        ...
	        byte[] certBytes = parseDERFromPEM(Files.readAllBytes(new File(certFolder, "cert.pem").toPath()), "-----BEGIN CERTIFICATE-----", "-----END CERTIFICATE-----");
	        byte[] keyBytes = parseDERFromPEM(Files.readAllBytes(new File(certFolder, "privkey.pem").toPath()), "-----BEGIN PRIVATE KEY-----", "-----END PRIVATE KEY-----");
